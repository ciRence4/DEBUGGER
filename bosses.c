...
void init_bosses(Boss bosses[NUM_BOSSES]) {
...

    {
        ...
        int r;
        bosses[2].art_row_count = 24; bosses[2].art_color = C_BLUE;
        for (r = 0; r < 24; r++)
...

    {
        ...
        int r;
        bosses[3].art_row_count = 24; bosses[3].art_color = C_BMAGENTA;
        for (r = 0; r < 24; r++)
...

    {
        ...
        int r;
        bosses[4].art_row_count = 24; bosses[4].art_color = C_BGREEN;
        for (r = 0; r < 24; r++)
...

    {
        const char *art[] = {
            ...
            "                           ",
            "  -> points to nothing     ",
            "  -> leads you off the map ",
        };
        int r;
        bosses[5].art_row_count = 24; bosses[5].art_color = C_WHITE;
        for (r = 0; r < 24; r++)
...

    {
        ...
        int r;
        bosses[6].art_row_count = 24; bosses[6].art_color = C_BRED;
        for (r = 0; r < 24; r++)
